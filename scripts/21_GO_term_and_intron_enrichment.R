...
panel_6 <- ggarrange(go.pl.brain, 
                     intron.pl.brain, 
                     widths = c(0.7, 0.3),
                     align = 'h')


ggsave(filename = paste0(figure_dir, "21_GO_term_te_enrichment.pdf"),
       panel_6,
       device = cairo_pdf,
       width = 20,
       height = 10,
...
ggsave(filename = './manuscripts/nature_aging/resis/figures/figure6/6_GO_plus_bootstrap.pdf' ,
       panel_6,
       device = cairo_pdf,
       width = 20,
       height = 10,
...
write.csv(data_clean_brain, file = './manuscripts/nature_aging/resis/figures/figure6/6A_GO_results.csv')

write.csv(brain_bootstrap.GO.result, 
          file = './manuscripts/nature_aging/resis/figures/figure6/6B_bootstrap_GO_results.csv',
          row.names = FALSE)
...
# 
# 
# supplemental_skin <- ggarrange(go.pl.skin, 
#                      intron.pl.skin, 
#                      widths = c(0.7, 0.3),
#                      align = 'h')
# 
...
# 
# 
# supplemental_blood <- ggarrange(go.pl.blood, 
#                                intron.pl.blood, 
#                                widths = c(0.7, 0.3),
#                                align = 'h')
# 
